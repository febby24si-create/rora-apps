package com.example.andesiaapps.Message.tutorial
...
import com.example.andesiaapps.databinding.ActivityTutorialMessageBinding
...
class TutorialMessageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Menghubungkan ViewPager2 dengan DotsIndicator
